...
1. Visión y Alcance (hecho).
2. Acta de Constitución + Caso de Negocio (uno solo).
3. SRS (Especificación de Requisitos) – donde ya estamos con IRF\_XX.
4. Arquitectura de Software – una versión inicial, que luego actualizas.
5. Plan de Proyecto – aquí metes:
6. Gantt,
7. esfuerzo por fases,
8. y presupuesto ficticio.
9. Guía de Gestión Ágil (Scrum/Kanban) – detalle de Jira, sprints, DoD.
10. Plan de Pruebas.
11. Registro de Riesgos.
12. SLA interno.
13. Al acercarte a 0.1.0: Manual de Usuario + Manual Técnico.
